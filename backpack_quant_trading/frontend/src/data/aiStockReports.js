export const AI_STOCK_REPORTS = [
  ...
  },
  {
    ...
    report: {
      business: {
        title: '业务情况',
        left: '行业前景、竞争地位（护城河）、市场份额/客户集中、产品线，成长性与定价权等',
        middle:
          '高端白酒龙头，品牌与渠道壁垒强，具备强定价权；成长性更多来自结构升级、渠道优化与稳健提价。',
        right: '稳健（强护城河）',
        target: 2200,
      },
      finance: {
        title: '财务状况',
        left: '营收/利润增长、ROE/ROIC、自由现金流（FCF）、负债率',
        middle: '盈利稳定、现金流强，负债低，分红与回购能力强。',
        right: '优秀',
      },
      valuation: {
        title: '估值指标',
        left: 'P/E、PEG、EV/EBITDA、P/B、P/S、FCF Yield',
        middle: '估值通常反映稳健预期；在消费预期改善/政策催化下有估值修复空间。',
        right: '中性偏合理',
      },
      profitability: {
        title: '盈利能力',
        left: '毛利率/净利率、EPS 增长、一致性',
        middle: '毛利净利高且稳定，EPS 增长平稳，一致性强。',
        right: '稳健',
      },
      technical: {
        title: '技术面',
        left: '趋势、支撑/阻力、成交量、RSI/MACD',
        middle: '偏震荡，等待放量突破或回踩确认。',
        right: '区间思路',
        key_level: 1800,
      },
      catalysts: {
        title: '催化剂',
        left: '产品、宏观、政策、行业景气',
        middle: '消费复苏、政策边际改善、提价与结构升级是主要催化。',
        right: '关注消费数据与渠道',
      },
      external: {
        title: '被动影响',
        left: '产业链/竞品联动',
        middle: '行业竞争与渠道政策变化会影响节奏，但龙头相对抗压。',
        right: '较稳',
      },
      safety: {
        title: '安全边际',
        left: '下行风险、波动率',
        middle: '相对低波动，适合偏防守配置。',
        right: '中等偏高',
      },
      conclusion: {
        title: '总结',
        text: '以防守型核心仓为主，结合区间波动做 T；关注消费与政策边际变化。',
      },
    },
  },
]
