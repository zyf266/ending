    ...
    <div className="page grid-page">
      ...
      <div className="config-card card-block">
        ...
        <div className="form-actions">
          ...
          <button type="button" className="btn-danger" disabled={stopping} onClick={stopAll}>
            {stopping ? '停止中...' : '停止全部网格'}
          </button>
        </div>
      ...
      <div className="instances-card card-block">
        ...
        {grids.length === 0 ? (
          <div className="empty">网格未启动，点击上方「启动当前类型网格」新增实例</div>
        ) : (
      ...
      <div className="card-block">
        ...
        <div className="log-area">暂无日志</div>
      </div>
    </div>
  )
}
