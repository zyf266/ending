...
- 组件层：StatCard.jsx/StatCard.css 为通用统计卡片组件
...
- [Dashboard.css:68-344](file://backpack_quant_trading/frontend/src/views/Dashboard.css#L68-L344)
...
- [MainLayout.jsx:45-63](file://backpack_quant_trading/frontend/src/layouts/MainLayout.jsx#L45-L63)
...
### StatCard 组件（可复用统计卡片）
- 功能：进度条背景、标题、数值、百分比、涨跌变化、图标区域
- 样式：进度条、数值、涨跌颜色、图标容器等
...
**章节来源**
- [dashboard.py:22-23](file://backpack_quant_trading/api/routers/dashboard.py#L22-L23)
- [models.py:65-226](file://backpack_quant_trading/database/models.py#L65-L226)
